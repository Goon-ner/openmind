...
export type { NewNFT } from "./NewNFT";
export type { NewNFTMarket } from "./NewNFTMarket";
...
export { NewNFT__factory } from "./factories/NewNFT__factory";
export { NewNFTMarket__factory } from "./factories/NewNFTMarket__factory";
